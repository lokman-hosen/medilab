                                    ...
                                    <div className="row">
                                        <div className="col-lg-8 details order-2 order-lg-1">
                                            ...
                                            <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint.
                                                ...
                                                Est repellat minima eveniet eius et quis magni nihil. Consequatur
                                    ...
                                    <div className="row">
                                        <div className="col-lg-8 details order-2 order-lg-1">
                                            ...
                                            <p>Ea ipsum voluptatem consequatur quis est. Illum error ullam omnis quia et
                                                ...
                                                et velit ipsa voluptates. Optio nesciunt eaque beatae accusamus lerode
                                ...
                                <div className={`tab-pane ${tab == 'tab-3' ? 'active show' : ''}`} id="tab-3">
                                    <div className="row">
                                        <div className="col-lg-8 details order-2 order-lg-1">
                                            ...
                                            <p className="fst-italic">Eos voluptatibus quo. Odio similique illum id
                                                quidem non enim fuga. Qui natus non sunt dicta dolor et. In asperiores
                                                velit quaerat perferendis aut</p>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-8 details order-2 order-lg-1">
                                            <h3>Fuga dolores inventore laboriosam ut est accusamus laboriosam
                                                dolore</h3>
                                            <p className="fst-italic">Totam aperiam accusamus. Repellat consequuntur
                                                iure voluptas iure porro quis delectus</p>
                                            <p>Eaque consequuntur consequuntur libero expedita in voluptas. Nostrum
                                                ipsam necessitatibus aliquam fugiat debitis quis velit. Eum ex maxime
                                                error in consequatur corporis atque. Eligendi asperiores sed qui
                                                veritatis aperiam quia a laborum inventore</p>
                                        </div>
                                        <div className="col-lg-4 text-center order-1 order-lg-2">
